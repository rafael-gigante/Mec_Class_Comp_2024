...
m₁ = 3.0 # Massa da extremidade 1
m₂ = 1.0 # Massa da extremidade 2
posição = Vetor2D(5.0, 5.0) # Posição inicial do CM do bastão
velocidade = Vetor2D(5.0, 10.0) # Velocidade inicial do CM do bastão
...
ω = 100.0 # Velocidade angular do bastão
